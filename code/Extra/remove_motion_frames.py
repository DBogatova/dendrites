#!/usr/bin/env python
"""
Motion Filter: Remove bad frames entirely instead of setting to NaN

This approach:
1. Detects motion frames using MIP-based correlation scoring
...
RAW_STACK_PATH = BASE / "raw" / "runA_run1_rAi162_15_v1_reslice-crop.tif"
MIP_PATH = BASE / "raw" / "runA_run1_rAi162_15_v1_processed-crop.tif"
...
QC_PDF = PREPROCESSED / "motion_filter.pdf"
